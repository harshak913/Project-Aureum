...
for entry in entries:
    ...
    name = str(entry[2])
    print(cik)
    #first run 2009-2014 = list(range(2009, 2015)), next is 2015-2020
    years = list(range(2015, 2021))
    #items per comp to see how many items have been parsed
    years_per_comp = 0
    for year in years:
        current_year = year
    ...
    #895421
            ...
            print('TOTAL AMOUNT OF YEARS COMPLETED FOR ' + name + ' IS: ' + str(years_per_comp))
