...
if q1 == True and q2 == True and q3 == True:
    ...
    for item in quarter_list:
        ...
        for table in tables:
            ...
            if 'months_ended' in item:
                ...
                if table == 'income':
                    scrape_query = "select * from %s where accession_number = '%s' and months_ended  = '%s' and date_part('year', year) = '%s';"%(table, accession_number, '3 Months Ended', current_year)
                else:
    ...
    q2_income_f = q2_income
    q3_income_f = q3_income
    q4_income_f = q4_income
